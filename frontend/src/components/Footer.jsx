...
function Footer() {
  return (
    <>
    <div className='flex flex-col gap-12 mt-6 mb-5 text-sm sm:gap-32 sm:flex-row outfit'>
      ...
      <div className='flex flex-col outfit gap-2 [&>*]:opacity-90'> <h1 className='text-xl font-semibold'>GET IN TOUCH</h1><p className='outfit'>+923223173020 </p>
